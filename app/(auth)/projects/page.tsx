        ...
        <div className="m-20">
            ...
            {Add && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-40 text-black">
                    <form onSubmit={HandleAdd} className="bg-white p-8 rounded-lg shadow-lg space-y-6">
